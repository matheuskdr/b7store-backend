...
import { getStripeSecretKey } from "../utils/get-stripe-srecret-key";
...
export const createStripeCheckoutSeesion = async ({
    cart,
    shippingCost,
    orderId,
...
export const getConstructEvent = async (
    ...
    try {
        return stripe.webhooks.constructEvent(rawBody, sig, webhook);
    } catch {
        return null;
    }
};
